...
import BingCrosbyJingleBells_mp3 from './HappyNewYear/sounds/Bing Crosby--Jingle Bells (1943).mp3'

var audio = new Audio(BingCrosbyJingleBells_mp3);
audio.loop = true;
